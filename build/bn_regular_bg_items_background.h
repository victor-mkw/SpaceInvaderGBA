...
#define background_bn_gfxTilesLen 17152
extern const bn::tile background_bn_gfxTiles[536];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item background(
            regular_bg_tiles_item(span<const tile>(background_bn_gfxTiles, 536), bpp_mode::BPP_4, compression_type::NONE), 
